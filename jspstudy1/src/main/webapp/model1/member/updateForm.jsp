...
<%--/jspstudy1/src/main/webapp/model1/member/updateForm.jsp
	...
	2. 로그인상태 검증
		  ...
		  - 로그인 상태
		  		- 다른 id 수정(관리자 제외) : '내 정보만 수정할 수 있습니다.' 메세지 출력 후 main.jsp 호출 
	3. db에서 id에 해당하는 데이터 조회하기
	4. 조회된 내용 화면에 출력하기 => 이전 데이터를 화면 출력. 수정 전 화면 출력.
 --%>  
 <%
 //1
...
<tr><td rowspan="4" valign="bottom">
	<img style= object-fit:cover; src="picture/<%=mem.getPicture() %>" width="350" id="pic"><br>
	<font size = "1"><a href = "javascript:win_upload()">사진수정</a></font>
</td><th>아이디</th>
<td><input type="text" name="id" readonly value="<%=mem.getId()%>"></td></tr>
<tr><th>비밀번호</th><td><input type="password" name="pass"></td></tr>
<tr><th>이름</th>
<td><input type="text" name="name" value="<%=mem.getId()%>"></td></tr>
<tr><th>성별</th>
