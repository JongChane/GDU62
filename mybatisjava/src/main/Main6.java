...
public class Main6 {
	...
	public static void main(String[] args) {
		...
		Student dbst = session.getMapper(cls).selectStudno(1003);
		...
		dbst = session.getMapper(cls).selectStudno(1003);
		System.out.println(dbst);
		System.out.println("1003번 학생 정보 삭제하기");
		cnt = session.getMapper(cls).delete(1003);
		dbst = session.getMapper(cls).selectStudno(1003);
		System.out.println(dbst);
