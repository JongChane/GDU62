...
<div class="container">
	...
	<div class="row">
		<div class="col-3 bg-light" id="center">
			<img src="" width="95%" height="250" id="pic"><br>
		...
		<div class="col-9">
			...
			<input type="button" class="btn btn-dark" value="중복체크" onclick="idchk()"><br>
			<label for="pwd">비밀번호:</label>
			<input type="password" class="form-control" name="pass" id="pwd">
			<label for="name">이름:</label>
			<input type="text" class="form-control" name="name" id="name">
	    <label for="gender">성별:</label>
			<label class="rdaio-inline"></label>
			<input type="radio" name="gender" checked value="1">남	<label class="rdaio-inline"></label>
	...
	<div class="form-group">
		<label for="tel">전화번호:</label><input type="text" class="form-control" name="tel" id="tel">
	</div>
	<div class="form-group">
		<label for="email">이메일:</label><input type="text" class="form-control" name="email" id="email">
	</div>
